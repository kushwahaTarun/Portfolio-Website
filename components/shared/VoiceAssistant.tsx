...
export function VoiceAssistant() {
  ...
  const statusLabel: Record<Status, string> = {
    idle: turns.length === 0 ? "Tap to speak" : "Tap to ask another question",
    listening: "Listening…",
    thinking: "Thinking…",
    speaking: "Speaking…",
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-[60] flex justify-end p-4 sm:p-6">
      <div className="pointer-events-auto flex items-end gap-3 max-w-full">
        <AnimatePresence>
          {hasContent && (
            <motion.div
              key="bubbles"
              ...
              className="flex w-[min(78vw,320px)] flex-col items-end gap-2 pb-2 text-sm"
            >
              {!supported && (
                <Bubble tone="warn">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            <span
              className={cn(
                "rounded-full bg-white/90 px-3 py-1 text-[11px] font-medium shadow-[0_4px_14px_-4px_rgba(28,24,21,0.2)] backdrop-blur",
